...
export default function AddFile({ fileNames, setFileNames }) {
	...
	const addFile = (e) => {
		...
		setFileNames((prevFiles) => [...prevFiles, newFile]);
	...
	return (
		<div>
			<div className=" relative flex items-center">
				<form onSubmit={addFile} className="flex">
					<button
						onClick={addFile}
						type="button"
						className="text-white transition-all duration-400 hover:border-blue-800 font-medium rounded-xl text-lg py-1 px-2 mx-3 border-b-2 border-b-blue-700 dark:hover:bg-blue-400 dark:hover:border-blue-700 dark:focus:bg-blue-500"
					>
						<strong className="text-red-700 text-2xl">+</strong> Add File
					</button>
					...
					<span className="absolute inset-y-0 right-0 flex items-center shadow-2xl">
