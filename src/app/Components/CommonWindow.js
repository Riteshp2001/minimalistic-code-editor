				...
				{fileNames.map((file) => (
					...
					>
						<span
							...
							className={`cursor-pointer transition-all duration-500 stroke-white text-center overflow-hidden inline-block hover:underline hover:underline-offset-4 hover:text-black ${
